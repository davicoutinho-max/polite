package dev.civicpulse.fundraising.config;
...
public class KafkaProducerConfig {
   ...
   * Must stay in sync with docs/db/fundraising-service/schema.sql's "Domain events published"
   * list. */
  private static final String TYPE_MAPPINGS =
      "FundraiserCreated:" + FundraiserCreated.class.getName() + "," //
          + "ContributionReceived:" + ContributionReceived.class.getName() + "," //
          + "FundraiserGoalReached:" + FundraiserGoalReached.class.getName();
