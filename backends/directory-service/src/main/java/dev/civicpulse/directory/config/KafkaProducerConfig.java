...
public class KafkaProducerConfig {
  ...
  /** Symbolic type ids for this service's published events — see identity-service's
   * KafkaProducerConfig for the full rationale. Must stay in sync with
   * docs/db/directory-service/schema.sql's "Domain events published" list. */
  private static final String TYPE_MAPPINGS =
      "FollowCreated:" + FollowCreated.class.getName() + "," + "FollowRemoved:" + FollowRemoved.class.getName();
