...
public class KafkaProducerConfig {
   ...
   * Must stay in sync with docs/db/feed-content-service/schema.sql's "Domain events published"
   * list. */
  private static final String TYPE_MAPPINGS =
      "PostPublished:" + PostPublished.class.getName() + "," //
          + "PostLiked:" + PostLiked.class.getName() + "," //
          + "CommentAdded:" + CommentAdded.class.getName();
