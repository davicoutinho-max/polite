package dev.civicpulse.analytics.config;
...
public class KafkaConsumerConfig {
  ...
  private static final String TYPE_MAPPINGS =
      "PostPublished:" + PostPublishedMessage.class.getName() + "," //
          + "PostLiked:" + PostLikedMessage.class.getName() + "," //
          + "CommentAdded:" + CommentAddedMessage.class.getName() + "," //
          + "FollowCreated:" + FollowCreatedMessage.class.getName() + "," //
          + "FollowRemoved:" + FollowRemovedMessage.class.getName();
  ...
  public ConsumerFactory<String, Object> consumerFactory(@Value("${spring.kafka.bootstrap-servers}") String bootstrapServers) {
    Map<String, Object> props =
        Map.of(
            ...
            JsonDeserializer.TRUSTED_PACKAGES, "dev.civicpulse.analytics.adapter.in.messaging.dto",
