...
public class KafkaConsumerConfig {
  ...
  private static final String TYPE_MAPPINGS = "ErasureCompleted:" + ErasureCompletedMessage.class.getName();
  ...
  public ConsumerFactory<String, Object> consumerFactory(@Value("${spring.kafka.bootstrap-servers}") String bootstrapServers) {
    Map<String, Object> props =
        Map.of(
            ...
            ConsumerConfig.GROUP_ID_CONFIG, "privacy-compliance-service",
            ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class,
            ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class,
            ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest",
            JsonDeserializer.TRUSTED_PACKAGES, "dev.civicpulse.privacycompliance.adapter.in.messaging.dto",
