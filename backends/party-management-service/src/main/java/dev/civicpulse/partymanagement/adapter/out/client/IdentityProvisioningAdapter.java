...
class IdentityProvisioningAdapter implements IdentityProvisioningGateway {
  ...
  @Override
  public ProvisionedAccount provisionPoliticianAccount(
    ...
    try {
      IdentityAccountResponse response =
          restClient
              ...
              .body(new ProvisionAccountRequest("politician", name, handle, email, rawPassword, documentType, rawDocumentNumber))
              .retrieve()
  ...
  @Override
  public ProvisionedAccount provisionSyncedPoliticianAccount(
      String name,
      String handle,
      String email,
      String avatarUrl,
          ...
          restClient
              ...
              .body(
                  new ProvisionSyncedAccountRequest(
                      "politician", name, handle, email, avatarUrl, documentType, rawDocumentNumber, externalSource, externalId))
              .retrieve()
              .body(IdentityAccountResponse.class);
      if (response == null) {
