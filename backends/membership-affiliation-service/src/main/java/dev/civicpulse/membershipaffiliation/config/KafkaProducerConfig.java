...
public class KafkaProducerConfig {
   ...
   * Must stay in sync with docs/db/membership-affiliation-service/schema.sql's "Domain events
   * published" list. */
  private static final String TYPE_MAPPINGS =
      "AffiliationRequested:" + AffiliationRequested.class.getName() + "," //
          + "AffiliationUnderReview:" + AffiliationUnderReview.class.getName() + "," //
          + "AffiliationConfirmed:" + AffiliationConfirmed.class.getName() + "," //
          + "MembershipCardIssued:" + MembershipCardIssued.class.getName() + "," //
          + "MembershipFeeGenerated:" + MembershipFeeGenerated.class.getName() + "," //
          + "MembershipFeeOverdue:" + MembershipFeeOverdue.class.getName();
